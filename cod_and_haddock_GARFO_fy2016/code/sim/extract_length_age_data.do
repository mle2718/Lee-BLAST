cd "/home/mlee/Documents/Workspace/recreational_simulations/cod_and_haddock_GARFO_fy2016/source_data"
...
compress;
save cod_svspp_raw.dta, replace;
...
destring, replace;
sort cruise6;
save fall_spring_cruises.dta, replace;

use cod_svspp_raw.dta, clear;
merge m:1 cruise6 using fall_spring_cruises.dta;
keep if _merge==3;
drop _merge;
sort season;
...
save cod_fall_spring.dta, replace;
...
collapse (sum) count, by(year season svspp age length);
sort svspp year age length count;
save haddock_fall_spring.dta, replace;
