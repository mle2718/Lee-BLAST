...
log using "/home/mlee/Documents/Workspace/recreational_simulations/cod_and_haddock_GARFO_fy2016/cod_haddock_2016_sim_w25cal.smcl", replace
version 12
clear
mata:mata clear
macro drop _all
...
local econ_out "economic_data2016sim_w25cal.dta"
local rec_out "recreational_catches2016sim_w25cal.dta"
local sp1_out "cod_end_of_wave2016sim_w25cal.dta"
local sp2_out "haddock_end_of_wave2016sim_w25cal.dta"
local cod_catch_class "cod_catch_class_dist_2015_w25cal.dta"
local haddock_catch_class "haddock_catch_class_2015_w25cal.dta"

local cod_land_class "cod_land_class_dist_2015_w25cal.dta"
local haddock_land_class "haddock_land_class_2015_w25cal.dta"
...
*/
 global cod_historical_sizeclass cod_size_class20145_20154MOD25.dta  /* this is old */
 global haddock_historical_sizeclass haddock_size_class20145_20154MOD25.dta  /* this is old */
...
global cod_catch_class cod_catch_class20145_20154MOD25.dta /* this is new */
global haddock_catch_class haddock_catch_class20145_20154MOD25.dta /* this is new*/
...
order id
drop u1 u2
save"/home/mlee/Documents/Workspace/recreational_simulations/cod_and_haddock_GARFO_fy2016/source_data/cod agepro/cod_beginning_sorted2015.dta", replace
...
order id
drop u1 u2
save "/home/mlee/Documents/Workspace/recreational_simulations/cod_and_haddock_GARFO_fy2016/source_data/haddock agepro/haddock_beginning_sorted2015.dta", replace
...
mata:  hmin_cy15[2]=99 */
	...
	/*
	mata: cbag_cy16[3]=`cod_bag'
	mata: cbag_cy16[4]=`cod_bag'
	mata: cbag_cy17[3]=`cod_bag'
	mata: cbag_cy17[4]=`cod_bag'

	mata: cmin_cy16[3]=`cod_min'
	mata: cmin_cy16[4]=`cod_min'
	mata: cmin_cy17[3]=`cod_min'
	mata: cmin_cy17[4]=`cod_min' */
...
mata: cod_bag_vec=cod_bag_vec[|$rec_wave_starter \.|]
mata: haddock_min_vec=haddock_min_vec[|$rec_wave_starter \.|]
mata: haddock_max_vec=haddock_max_vec[|$rec_wave_starter \.|]
mata: cod_min_vec=cod_min_vec[|$rec_wave_starter \.|]
mata: cod_max_vec=cod_max_vec[|$rec_wave_starter \.|]
...
use "/home/mlee/Documents/Workspace/recreational_simulations/cod_and_haddock_GARFO_fy2016/source_data/haddock agepro/haddock_beginning_sorted2015.dta", replace
...
use "/home/mlee/Documents/Workspace/recreational_simulations/cod_and_haddock_GARFO_fy2016/source_data/cod agepro/cod_beginning_sorted2015.dta", clear
keep if id==`replicate'
...
clear
do "updated_recreational_effort_helper25open.do"
