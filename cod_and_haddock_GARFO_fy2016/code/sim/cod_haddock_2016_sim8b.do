...
log using "/home/mlee/Documents/Workspace/recreational_simulations/cod_and_haddock_GARFO_fy2016/cod_haddock_2016_sim8b.smcl", replace
version 12
clear
mata:mata clear
macro drop _all
...
local econ_out "economic_data2016sim8b.dta"
local rec_out "recreational_catches2016sim8b.dta"
local sp1_out "cod_end_of_wave2016sim8b.dta"
local sp2_out "haddock_end_of_wave2016sim8b.dta"
local cod_catch_class "cod_catch_class_dist_2015_sim8b.dta"
local haddock_catch_class "haddock_catch_class_2015_sim8b.dta"

local cod_land_class "cod_land_class_dist_2015_sim8b.dta"
local haddock_land_class "haddock_land_class_2015_sim8b.dta"
...
local scenario_num=300
foreach had_bag of numlist 20 35{
foreach cod_bag of numlist 1 {
foreach cod_min of numlist 22{
foreach cwave of numlist 4 {
	local ++scenario_num
	local had_min 17
