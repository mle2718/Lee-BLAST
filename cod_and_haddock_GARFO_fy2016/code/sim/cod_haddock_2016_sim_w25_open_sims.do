...
log using "/home/mlee/Documents/Workspace/recreational_simulations/cod_and_haddock_GARFO_fy2016/cod_haddock_2016_sim_w25open.smcl", replace
version 12
clear
mata:mata clear
macro drop _all
...
local econ_out "economic_data2016sim_w25open.dta"
local rec_out "recreational_catches2016sim_w25open.dta"
local sp1_out "cod_end_of_wave2016sim_w25open.dta"
local sp2_out "haddock_end_of_wave2016sim_w25open.dta"
local cod_catch_class "cod_catch_class_dist_2016_w25open.dta"
local haddock_catch_class "haddock_catch_class_2016_w25open.dta"

local cod_land_class "cod_land_class_dist_2016_w25open.dta"
local haddock_land_class "haddock_land_class_2016_w25open.dta"
...
local scenario_num=41
foreach had_bag of numlist 3 8 35{
	local ++scenario_num
	local had_min 17
