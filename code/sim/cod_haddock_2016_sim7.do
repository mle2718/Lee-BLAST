...
log using "/home/mlee/Documents/Workspace/recreational_simulations/cod_and_haddock_GARFO_fy2016/cod_haddock_2016_sim7.smcl", replace
version 12
clear
mata:mata clear
macro drop _all
...
local econ_out "economic_data2016sim7.dta"
local rec_out "recreational_catches2016sim7.dta"
local sp1_out "cod_end_of_wave2016sim7.dta"
local sp2_out "haddock_end_of_wave2016sim7.dta"
local cod_catch_class "cod_catch_class_dist_2015_sim7.dta"
local haddock_catch_class "haddock_catch_class_2015_sim7.dta"

local cod_land_class "cod_land_class_dist_2015_sim7.dta"
local haddock_land_class "haddock_land_class_2015_sim7.dta"
...
local scenario_num=18
foreach had_bag of numlist 8 35 {
foreach cod_bag of numlist 1 2 {
foreach cod_min of numlist 22 23 24{
	local ++scenario_num
	local had_min 17
