...
clear
timer on 62
getmata (length released weight)=creleased_matrix
tempfile mctemp1
save `mctemp1'
clear
...
use `released'
keep length released age*


foreach var of varlist age*{
	replace `var'=`var'*released
}
collapse (sum) age*
...
append using `kept'
label define status_label 0 "Released" 1 "Kept" 2 "Initial"
...
/* HADDOCK OUT */
clear
getmata (length released weight)=hreleased_matrix
tempfile mhtemp1
save `mhtemp1'
clear
