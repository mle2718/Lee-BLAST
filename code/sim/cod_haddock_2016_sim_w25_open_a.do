...
log using "/home/mlee/Documents/Workspace/recreational_simulations/cod_and_haddock_GARFO_fy2016/cod_haddock_2016_w25opena.smcl", replace
version 12
clear
mata:mata clear
macro drop _all
...
local econ_out "economic_data2016w25opena.dta"
local rec_out "recreational_catches2016w25opena.dta"
local sp1_out "cod_end_of_wave2016w25opena.dta"
local sp2_out "haddock_end_of_wave2016w25opena.dta"
local cod_catch_class "cod_catch_class_dist_2016_w25opena.dta"
local haddock_catch_class "haddock_catch_class_2016_w25opena.dta"

local cod_land_class "cod_land_class_dist_2016_w25opena.dta"
local haddock_land_class "haddock_land_class_2016_w25opena.dta"
...
foreach had_bag of numlist 8 35{
foreach cod_bag of numlist 1{
foreach cod_min of numlist 23 24{
foreach cod_wave of numlist 3 4{
	...
	/* RESET all the CMIN to 99 and CBAG to 9 */
	mata: cmin_cy15=J(1,6,99)
	mata: cmin_cy16=J(1,6,99)
	mata: cmin_cy17=J(1,6,99)

	mata: cbag_cy15=J(1,6,9)
	mata: cbag_cy16=J(1,6,9)
	mata: cbag_cy17=J(1,6,9)

	/* OVERWRITE the bag limit and minimums in the "open" cod wave*/
	mata: cbag_cy16[`cod_wave']=`cod_bag'
	mata: cbag_cy17[`cod_wave']=`cod_bag'

	mata: cmin_cy16[`cod_wave']=`cod_min'
	mata: cmin_cy17[`cod_wave']=`cod_min'
