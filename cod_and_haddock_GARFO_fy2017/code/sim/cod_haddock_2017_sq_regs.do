...
log using "$my_wd/cod_and_haddock_2017_sq_regs_a.smcl", replace
version 12
...
local econ_out "$my_wd/economic_data2017_sq_regsa.dta"
local rec_out "$my_wd/recreational_catches2017_sq_regsa.dta"
local sp1_out "$my_wd/cod_end_of_wave2017_sq_regsa.dta"
local sp2_out "$my_wd/haddock_end_of_wave2017_sq_regsa.dta"
local cod_catch_class "$my_wd/cod_catch_class_dist_2017_sq_regsa.dta"
local haddock_catch_class "$my_wd/haddock_catch_class_2017_sq_regsa.dta"

local cod_land_class "$my_wd/cod_land_class_dist_2017_sq_regsa.dta"
local haddock_land_class "$my_wd/haddock_land_class_2017_sq_regsa.dta"
...
/*You need to specify the 2018 regs, i think for commercial */
