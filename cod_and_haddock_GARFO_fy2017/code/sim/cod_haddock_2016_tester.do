...
cd $my_wd
log using "$my_wd/cod_and_haddock_tester.smcl", replace
version 12
...
local econ_out "$mywd/economic_data2016_tester.dta"
local rec_out "$mywd/recreational_catches2016_tester.dta"
local sp1_out "$mywd/cod_end_of_wave2016_tester.dta"
local sp2_out "$mywd/haddock_end_of_wave2016_tester.dta"
local cod_catch_class "$mywd/cod_catch_class_dist_2016_tester.dta"
local haddock_catch_class "$mywd/haddock_catch_class_2016_tester.dta"

local cod_land_class "$mywd/cod_land_class_dist_2016_tester.dta"
local haddock_land_class "$mywd/haddock_land_class_2016_tester.dta"
...
*local max_waves=($waves*$total_years_sim) + 4
...
mata: recreational_effort_waves = (recreational_effort_waves \ recreational_effort_waves\ recreational_effort_waves \ recreational_effort_waves \ recreational_effort_waves\recreational_effort_waves\recreational_effort_waves)
mata: recreational_effort_monthly = (recreational_effort_waves \ recreational_effort_waves\ recreational_effort_waves \ recreational_effort_waves \ recreational_effort_waves\recreational_effort_waves\recreational_effort_waves)
