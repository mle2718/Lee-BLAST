...
log using "$my_wd/cod_and_haddock_2017_set1_a.smcl", replace
version 12
...
local econ_out "$my_wd/economic_data2017_set1a.dta"
local rec_out "$my_wd/recreational_catches2017_set1a.dta"
local sp1_out "$my_wd/cod_end_of_wave2017_set1a.dta"
local sp2_out "$my_wd/haddock_end_of_wave2017_set1a.dta"
local cod_catch_class "$my_wd/cod_catch_class_dist_2017_set1a.dta"
local haddock_catch_class "$my_wd/haddock_catch_class_2017_set1a.dta"

local cod_land_class "$my_wd/cod_land_class_dist_2017_set1a.dta"
local haddock_land_class "$my_wd/haddock_land_class_2017_set1a.dta"
...
*/
 ...
 global cod_historical_sizeclass "$my_data_dir/cod_size_class_2016_mod2.dta"  
 global haddock_historical_sizeclass "$my_data_dir/haddock_size_class_2016_mod2.dta" 
...
global cod_catch_class `""$my_data_dir/cod_catch_class_2016_mod.dta""' 
global haddock_catch_class `""$my_data_dir/haddock_catch_class_2016_mod.dta""' 

global cod_catch_class `""$my_data_dir/cod_catch_class_2016_mod2.dta""' 
...
foreach had_bag of numlist 15 10{
foreach cod_bag of numlist 1{
foreach cod_min of numlist 24{
foreach cod_month of numlist 0 8 9{
	...
	mata: cbag_cy17=J(1,$periods_per_year, 9)

	mata: cmin_cy18=J(1,$periods_per_year,99)
	mata: cbag_cy18=J(1,$periods_per_year, 9)

if `cod_month'!=0{
	mata: cbag_cy17[`cod_month']=`cod_bag'
	mata: cmin_cy17[`cod_month']=`cod_min'
	mata: cbag_cy18[`cod_month']=`cod_bag'
	mata: cmin_cy18[`cod_month']=`cod_min'
