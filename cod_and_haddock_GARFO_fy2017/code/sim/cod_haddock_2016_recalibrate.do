...
log using "$my_wd/cod_and_haddock_recalibrated_02_21_2016.smcl", replace
version 12
...
local econ_out "$my_wd/economic_data2016_recalibrated_02_21_2016.dta"
local rec_out "$my_wd/recreational_catches2016_recalibrated_02_21_2016.dta"
local sp1_out "$my_wd/cod_end_of_wave2016_recalibrated_02_21_2016.dta"
local sp2_out "$my_wd/haddock_end_of_wave2016_recalibrated_02_21_2016.dta"
local cod_catch_class "$my_wd/cod_catch_class_dist_2016_recalibrated_02_21_2016.dta"
local haddock_catch_class "$my_wd/haddock_catch_class_2016_recalibrated_02_21_2016.dta"

local cod_land_class "$my_wd/cod_land_class_dist_2016_recalibrated_02_21_2016.dta"
local haddock_land_class "$my_wd/haddock_land_class_2016_recalibrated_02_21_2016.dta"
...
clear
do "$my_wd/recalibrated_recreational_effort_helper16.do"
...
mata: cod_commercial_catch_monthly=(0 \ 0 \ $cod_quota1*cod_commercial_monthly[.,2] \ $cod_quota2*cod_commercial_monthly[.,2] \ $cod_quota3*cod_commercial_monthly[.,2]\ $cod_quota4*cod_commercial_monthly[.,2]\ $cod_quota5*cod_commercial_monthly[.,2] \ $cod_quota6*cod_commercial_monthly[.,2] \ $cod_quota7*cod_commercial_monthly[.,2])
mata: haddock_commercial_catch_monthly=(0 \ 0 \  $haddock_quota1*haddock_commercial_monthly[.,2] \ $haddock_quota2*haddock_commercial_monthly[.,2] \ $haddock_quota3*haddock_commercial_monthly[.,2]\ $haddock_quota4*haddock_commercial_monthly[.,2]\ $haddock_quota5*haddock_commercial_monthly[.,2] \ $haddock_quota6*haddock_commercial_monthly[.,2]\ $haddock_quota7*haddock_commercial_monthly[.,2])
