...
/*************
OPtion 7a 
The Groundfish Committee recommends to the Council, for fishing year 2019 management
measures:

Gulf of Maine haddock: a 17 in minimum fish size, a 15 fish bag limit, and an open
season of May 1 to February 28 then open again April 15 to April 30 (i.e., a closed
season March 1 to April 14), and

Gulf of Maine cod: a 21 in minimum fish size, a 1 fish bag limit, and an open season of
September 15 to September 30 and then open again April 15 to April 30 (i.e., a closed
season May 1 to September 14 and then closed again October 1 to April 14).
...
/* Age-length key years*/
 global lcalibration_start 2015
 global lcalibration_end 2017
...
global haddock_sublegal_hi=0.15+$haddock_sublegal_low
...
/* Overwrite to set up the desired regs: 
   Use the regs and assumptions from from scenario 2, but also allow 1 cod @ 23" to be retained in various months.

*/
/* Set "poor recruitment for cod */
...
haddock_min_vec[15]=99
haddock_min_vec[22]=99


haddock_bag_vec=J(1,length(haddock_bag_vec),15)

/* this doubles effort in september to account for baseline of september being half open*/
recreational_effort_months[9,2]=2*recreational_effort_months[9,2]

recreational_effort_months[10,2]=0.033
recreational_effort_months[11,2]=0.0014 

recreational_effort_monthly = J(10,1,recreational_effort_months) 
 cod_min_back=cod_min_vec
...
/*temporary cod minimums and bag limits */
global tempmin 21
global tempbag 1
...
local scenario_num =`mys'
local scenario_num `" `scenario_num' "'

di "`scenario_num'"
mata: cod_min_vec=cod_min_back
mata: cod_bag_vec=cod_bag_back

/*set the bag limit to 1 and minimum size to tempmin in months 4*/
mata: cod_min_vec[4]=$tempmin
mata: cod_bag_vec[4]=$tempbag


mata: cod_min_vec[16]=$tempmin
mata: cod_bag_vec[16]=$tempbag

*mata: cod_min_vec[9]=$tempmin
*mata: cod_bag_vec[9]=$tempbag
...
do "$code_dir/sim/simulation_v42a_always_on.do"
