...
export excel scenario total_trips cod_ok haddock_ok cod_dead_pounds cod_mortality_mt haddock_dead_pounds haddock_mortality_mt cod_num_kept cod_num_released haddock_num_kept haddock_num_released cod_pounds_kept cod_pounds_discard haddock_pounds_kept haddock_pounds_discard using "$my_wd/results_2017_exportG.xlsx", replace firstrow( varlabels) sheet("results") 

putexcel set "$my_wd/results_2017_exportG.xlsx", modify sheet(results)
...
export excel using "$my_wd/results_2017_exportG.xlsx",  firstrow(varlabels) sheet("regulations") sheetreplace 
...
export excel scenario reg_notes behavior_notes using "$my_wd/results_2017_exportG.xlsx",  firstrow(varlabels) sheet("quick_regs") sheetreplace 


! cp "/home/mlee/Documents/Workspace/recreational_simulations/cod_and_haddock_GARFO_fy2017/results_2017_exportG.xlsx" "/run/user/1877/gvfs/smb-share:server=net,share=home2/mlee/dropoff/results_2017_exportG.xlsx"
