...
local poststub "2018_data_update"
...
cd "$output_dir"
local store_name "RESULTS_SOME.xlsx"

local rec_out2  "${output_dir}/recreational_catches2019_open_2moFBR.dta"
local rec_out3  "${output_dir}/recreational_catches2019_open_2mo48a.dta"
local rec_out4  "${output_dir}/recreational_catches2019_open_2mo48b.dta"
local rec_out5  "${output_dir}/recreational_catches2019_open_2mo48c.dta"
local rec_out6  "${output_dir}/recreational_catches2019_open_2mo48d.dta"


/*
local rec_out3  "${output_dir}/recreational_catches2018_calibrated_BR.dta"
local rec_out4  "${output_dir}/recreational_catches2019_BR.dta"
local rec_out5  "${output_dir}/recreational_catches2019_open_2monthsBR.dta"
local rec_out6  "${output_dir}/recreational_catches2019_option1BR.dta"
local rec_out7  "${output_dir}/recreational_catches2019_option2BR.dta"
local rec_out8  "${output_dir}/recreational_catches2019_option3BR.dta"
local rec_out9  "${output_dir}/recreational_catches2019_option4BR.dta"



local rec_out10  "${output_dir}/recreational_catches2019_open_2moABR.dta"
local rec_out11  "${output_dir}/recreational_catches2019_open_2moBBR.dta"
local rec_out12  "${output_dir}/recreational_catches2019_open_monABR.dta"
local rec_out13  "${output_dir}/recreational_catches2019_open_monBBR.dta"
local rec_out14 "${output_dir}/recreational_catches2019_open_monthsBR.dta"

local rec_out15  "${output_dir}/recreational_catches2019_open_2moCBBR.dta"
local rec_out16  "${output_dir}/recreational_catches2019_open_monCBR.dta"
local rec_out17  "${output_dir}/recreational_catches2019_open_8910_ABR.dta"


local rec_out18  "${output_dir}/recreational_catches2019_open_8910_FBR.dta"
local rec_out19  "${output_dir}/recreational_catches2019_open_2moFBR.dta"
local rec_out20  "${output_dir}/recreational_catches2019_open_monFBR.dta"


local rec_out21  "${output_dir}/recreational_catches2019_open_8910_GBR.dta"
local rec_out22  "${output_dir}/recreational_catches2019_open_2moGBR.dta"
local rec_out23  "${output_dir}/recreational_catches2019_open_monGBR.dta"

*/


/*
local rec_out5  "${output_dir}/recreational_catches2019_open_monthsBR.dta"
