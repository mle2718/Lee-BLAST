...
global rec_management "2022_OS_sensA"
...
recreational_effort_months = (1,0.0 \ 2,0.0 \ 3, 0.00 \ 4, 0.271 \ 5, 0.0990 \ 6, 0.141 \ 7 ,0.095 \ 8, .130  \ 9 , .1692 \10, .0375 \ 11, .1420 \ 12,0.00)   
...
di "This is an simulation with Sept fully open for the private fleet, matching the regs of the for-hire fleet. I expect to see approximately 1.8x as much trips in September as we do under SQ regs"
log close
