...
global rec_management "2022_Round2"
...
local econ_out "${output_dir}/economic_data6_`poststub'"
local rec_out  "${output_dir}/recreational_catches6_`poststub'"
local sp1_out  "${output_dir}/cod_end_of_wave6_`poststub'"
local sp2_out  "${output_dir}/haddock_end_of_wave6_`poststub'"
local cod_catch_class  "${output_dir}/cod_catch_class_dist6_`poststub'"
local haddock_catch_class  "${output_dir}/haddock_catch_class6_`poststub'"
local cod_land_class  "${output_dir}/cod_land_class_dist6_`poststub'"
local haddock_land_class  "${output_dir}/haddock_land_class6_`poststub'"
local hla  "${output_dir}/haddock_length_class6_`poststub'"
local cla  "${output_dir}/cod_length_class6_`poststub'"
...
recreational_effort_months = (1,0.0 \ 2,0.0 \ 3, 0.00 \ 4, 0.271 \ 5, 0.0990 \ 6, 0.141 \ 7 ,0.095 \ 8, .130  \ 9 , .2285  \10, .0375 \ 11, .1420 \ 12,0.00)   
...
global scenario_num=$scenario_num+600
...
di "This is an simulation with Sept fully open for the private fleet, matching the regs of the for-hire fleet. October is also open for 2 weeks."
log close
