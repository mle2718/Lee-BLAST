...
global haddock2022a=$haddock2021a
...
*/
mata: cod_commercial_catch_monthly=(0 \ 0 \ $cod_quota1*cod_commercial_monthly[.,2] \ $cod_quota2*cod_commercial_monthly[.,2] \ $cod_quota3*cod_commercial_monthly[.,2]\ $cod_quota4*cod_commercial_monthly[.,2]\ $cod_quota5*cod_commercial_monthly[.,2] \ $cod_quota6*cod_commercial_monthly[.,2] \ $cod_quota7*cod_commercial_monthly[.,2]\ $cod_quota8*cod_commercial_monthly[.,2] \ $cod_quota9*cod_commercial_monthly[.,2] \ $cod_quota10*cod_commercial_monthly[.,2])
mata: haddock_commercial_catch_monthly=(0 \ 0 \  $haddock_quota1*haddock_commercial_monthly[.,2] \ $haddock_quota2*haddock_commercial_monthly[.,2] \ $haddock_quota3*haddock_commercial_monthly[.,2]\ $haddock_quota4*haddock_commercial_monthly[.,2]\ $haddock_quota5*haddock_commercial_monthly[.,2] \ $haddock_quota6*haddock_commercial_monthly[.,2]\ $haddock_quota7*haddock_commercial_monthly[.,2] \ $haddock_quota8*haddock_commercial_monthly[.,2] \ $haddock_quota9*haddock_commercial_monthly[.,2]  \ $haddock_quota10*haddock_commercial_monthly[.,2])
/* I think I can offload this to the "commercial_quotas.do" file.*/
