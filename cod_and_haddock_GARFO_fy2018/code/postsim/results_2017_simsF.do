...
do "/home/mlee/Documents/Workspace/recreational_simulations/cod_and_haddock_GARFO_fy2017/cod_haddock_2017_set12_hadd_stop.do"
...
dsconcat `rec_out1' `rec_out2' `rec_out3' `rec_out5' `rec_out6' `rec_out7' `rec_out8' `rec_out11' `rec_out10' `rec_out12'
...
export excel scenario total_trips cod_ok haddock_ok cod_dead_pounds cod_mortality_mt haddock_dead_pounds haddock_mortality_mt cod_num_kept cod_num_released haddock_num_kept haddock_num_released cod_pounds_kept cod_pounds_discard haddock_pounds_kept haddock_pounds_discard using "$my_wd/results_2017_exportF.xlsx", replace firstrow( varlabels) sheet("results") 

putexcel set "$my_wd/results_2017_exportF.xlsx", modify sheet(results)
...
dsconcat `rec_out1' `rec_out2' `rec_out3' `rec_out5' `rec_out6' `rec_out7' `rec_out8' `rec_out11' `rec_out10'
keep if replicate==1
gen cy=2016
...
export excel using "$my_wd/results_2017_exportF.xlsx",  firstrow(varlabels) sheet("regulations") sheetreplace 
...
replace reg_notes= "Cod closed all year. 8 haddock at 17in" if inlist(scenario,4,104,1004, 85, 185, 1085, 73, 173, 1073)
...
replace reg_notes= "Cod closed all year. 8 haddock at 17in. Haddock closed in Sept" if inlist(scenario,87,187,1087, 75, 175, 1075)
replace reg_notes= "Cod closed all year. 8 haddock at 17in. Haddock closed in October" if inlist(scenario,88,188,1088, 76, 176, 1076)
...
replace behavior_notes= "Stop encountering haddock once bag limit is reached. 10 max cod encounters.  50 max haddock" if scenario>=60 & scenario<=76 
...
replace  behavior_notes= behavior_notes + " Stop encountering haddock once bag limit is reached. 10 max cod encounters.  50 max haddock." if scenario>=160 &  scenario<=176 
replace  behavior_notes= behavior_notes + " Stop encountering haddock once bag limit is reached. 10 max cod encounters.  50 max haddock." if scenario>=1060 &  scenario<=1076 
...
export excel scenario reg_notes behavior_notes using "$my_wd/results_2017_exportF.xlsx",  firstrow(varlabels) sheet("quick_regs") sheetreplace 


! cp "/home/mlee/Documents/Workspace/recreational_simulations/cod_and_haddock_GARFO_fy2017/results_2017_exportF.xlsx" "/run/user/1877/gvfs/smb-share:server=net,share=home2/mlee/dropoff/results_2017_exportF.xlsx"
