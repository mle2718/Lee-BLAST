...
cod_nat_mort_counts=mcce:*mccd

cod_landing_counts_wave=my_cod_catch_counts1:*(ones-cod_discard_fraction)
cod_discard_counts_wave=my_cod_catch_counts1:*cod_discard_fraction

/*living cod */
cod_end_of_cm=cod_initial_counts:-cod_nat_mort_counts:-cod_landing_counts_wave:-$cod_comm_discard_mortality*cod_discard_counts_wave
...
cod_landing_counts_wave$current_wave = cod_landing_counts_wave
cod_discard_counts_wave$current_wave = cod_discard_counts_wave
cod_end_of_period_wave$current_wave=cod_end_of_cm
